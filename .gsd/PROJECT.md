...
- About page: layout exists but founder name, bio, and photo are placeholders
...
- [ ] M001: Site Enhancement v1 — Blog system, real About content, visual polish, and publish to GitHub
